...
$(function() {
	...
	var $musicImg=document.getElementById('music_img');
	var musicbut=false;
	$musicImg.onclick=function(){
		if(musicbut){
			$music.play();
			this.setAttribute('src','/static/campaigns/picc/mobile/image/kai.png');
		}else{
			$music.pause();
			this.setAttribute('src','/static/campaigns/picc/mobile/image/guan.png');
		}
		musicbut=!musicbut;
	}
});