var WX_share=function(){
			...
			var Url="http://fanta.kuh5.net/picc/index.html";
			var  TT='点亮孩子的梦想星空';
			var ImgUrl='http://fanta.kuh5.net/static/campaigns/picc/mobile/image/shakeimg.png';
			var Desc='公益助学，邀您一起，用爱心助力山区孩子心愿成真！';
			$.ajax({
				type: "POST",
				url: "http://fanta.kuh5.net/picc/get_sign_package",
				data: {
					url:IndexUrl
				},
				async: !0,
